...
import com.msix.admin.review.service.ARepReviewService;
...
@Log4j
@AllArgsConstructor
public class ARepReviewController {
	
	private ARepReviewService repReviewService;
	
	@GetMapping(value = "/all/{rv_no}", produces= {MediaType.APPLICATION_JSON_UTF8_VALUE} )
	public List<ARepReviewVO> replyList(@PathVariable("rv_no") Integer rv_no ){
